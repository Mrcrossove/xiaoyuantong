  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: "trade/supply", component: () => import("../views/trade/SupplyRequestView.vue"), meta: { title: "商品补给申请", menuPath: "/trade/supply" } },
        { path: "trade/withdraw", component: () => import("../views/trade/WithdrawListView.vue"), meta: { title: "提现审核", menuPath: "/trade/withdraw" } },
        { path: "travel/route", component: () => import("../views/travel/TravelRouteView.vue"), meta: { title: "线路管理", menuPath: "/travel/route" } },
        { path: "travel/booking", component: () => import("../views/travel/TravelBookingView.vue"), meta: { title: "报名管理", menuPath: "/travel/booking" } },
        { path: "travel/provider", component: () => import("../views/travel/TravelProviderView.vue"), meta: { title: "供应方管理", menuPath: "/travel/provider" } },
