...
export const env = {
  ...
  wechatPayProfitSharingReceiverType: process.env.WECHAT_PAY_PROFIT_SHARING_RECEIVER_TYPE || "MERCHANT_ID",
  wechatPayProfitSharingReceiverAccount: process.env.WECHAT_PAY_PROFIT_SHARING_RECEIVER_ACCOUNT || process.env.WECHAT_PAY_SP_MCH_ID || process.env.WECHAT_PAY_MCH_ID || "",
